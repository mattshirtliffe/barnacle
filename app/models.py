...
class User(db.Model):
    ...
    def decode_token(token):
        ...
        try:
            ...
            print("Expired token. Please login to get a new token")
...
class Lead(db.Model):
    ...
    has_accepted_terms = db.Column(db.Boolean(), nullable=False, default=False)
    company_name = db.Column(db.String(255), nullable=True, unique=False)
